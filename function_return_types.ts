function fAdd(n1: number, n2: number) {
...
function ffPrintResult2(num: number): undefined {
...
// a Type that describes a function regarding params and return value

type TypedCombinedValues = (a: number, b: number) => number;

let combinedTYpeFunction: TypedCombinedValues = fAdd;
